component {
	...
	function configure(){
		...
		interceptors = [
			{
				class : "interceptors.AccessInterceptor",
				properties : {}
			}
		];
		...
		moduleSettings = {
			...
			"twilio-sdk" = {
				// accountSID = "ACe4e255e28499135ee885Oef4eef36b82", // accountSID = "SK80e64c38714bef175c65ed15620c824b",
				// authToken = "47c1Oe1b6ff73890308e6cOc66dbb17d" // authToken = "8tAP6RI1h8gvqsuff4oIGxyQJHASEp3r"
				accountSID = "AC38e6b8674ef492d4c419dcbba04e3e08", // 
				authToken = "c9954158f325bcad23a7ce3be82563b3" // 
			}
		};
